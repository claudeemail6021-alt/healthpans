...
export const products: Product[] = [
  ...
  },
  {
    ...
    pros: ["The safest cookware material on this list — zero detectable metal leaching", "Handcrafted in France since 1850 by a family-owned maker", "Goes from freezer directly to a hot oven without cracking", "Condensation-return lid keeps braises moist without added liquid", "10-year warranty against manufacturing defects"],
    cons: ["Induction cooktops require a separate diffuser disk — not directly induction compatible", "Fragile — ceramic chips or cracks if dropped", "Heavier than enameled cast iron of a similar size", "Slower to heat than metal core pans, by design"],
    safetyProfile: "Among the safest cookware materials available. Emile Henry's Flame ceramic is fired from natural Burgundy clay with mineral-oxide glazes — no lead, cadmium, or nickel, eliminating metal leaching entirely.",
    compatibility: ["Gas", "Electric", "Induction (with diffuser disk)", "Oven (930°F)", "Microwave", "Dishwasher", "Broiler", "BBQ Grill"],
    howToUse: "Start on low-to-medium heat — ceramic is a heat diffuser, not a fast conductor, so avoid high heat from a cold start. Add oil before food. Hand wash or dishwasher safe; avoid thermal shock by not moving directly from very hot to icy cold water.",
    whoItsFor: "Those avoiding metal cookware entirely, and anyone who wants a genuine Dutch oven for slow braises and stews without cast iron's weight or enamel coating.",
    notFor: "Those who want quick sear response — ceramic's gentle, even heat is built for slow cooking, not high-heat searing. Homes with children who might drop the pot.",
    faq: [
